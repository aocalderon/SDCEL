...
\begin{figure}[!ht]
    ...
    \subfloat[MainUS Speed Up \label{fig:mainus_speedup}]{%
        \includegraphics[width=0.45\linewidth]{figures/experiments/MainUS_speedup.pdf}
    }
    \hfill
    \subfloat[MainUS Scale Up \label{fig:mainus_scaleup}]{%
        %\includegraphics[width=0.45\linewidth]{figures/experiments/MainUS_scaleup.pdf}
    }
...
\begin{figure}[!ht]
    ...
    \subfloat[GADM Speed Up \label{fig:gadm_speedup}]{%
        \includegraphics[width=0.45\linewidth]{figures/experiments/GADM_speedup.pdf}
    }
    \hfill
    \subfloat[GADM Scale Up \label{fig:gadm_scaleup}]{%
        %\includegraphics[width=0.45\linewidth]{figures/experiments/GADM_scaleup.pdf}
    }
