...
\begin{figure}[!ht]
    ...
    \subfloat[SDCEL vs CGAL. \label{fig:ca_a}]{%
        \includegraphics[width=0.45\linewidth]{figures/experiments/CA/CA.pdf}}
    \hfill
    \subfloat[Focus on the most relevant number of partitions. \label{fig:ca_b}]{%
        \includegraphics[width=0.45\linewidth]{figures/experiments/CA/CA_sample.pdf}}
...
\begin{figure}[!ht]
    ...
    \subfloat[SDCEL execution time. \label{fig:gadm_a}]{%
        \includegraphics[width=0.45\linewidth]{figures/experiments/GADM/GADM.pdf}}
    \hfill
    \subfloat[Focus on the most relevant number of partitions. \label{fig:gadm_b}]{%
        \includegraphics[width=0.45\linewidth]{figures/experiments/GADM/GADM_sample.pdf}}
