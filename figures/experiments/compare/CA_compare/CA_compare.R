library(tidyverse)
setwd("/home/and/Documents/Papers/SDCEL/figures/experiments/compare/CA_compare/")

data0 = enframe(read_lines("CA_compare_v01.txt"), value="line")

data1 = data0 %>%
  filter(str_detect(line, '\\|TIME\\|')) 

fields1 = c("ts","start","appId","time","tag","stage","data")
fields2 = c("ds", "dataset", "tolerance", "overlay_method", "overlay_level", "partitions", "nodes", "run")
fields3 = c(NA, "l1l2")
data2 = data1 %>% 
